# CFD-Learn
A comprehensive repository for self-learning fluid dynamics programming
...
- [JHU-NI-LAB/OpenLPT_Shake-The-Box](https://github.com/JHU-NI-LAB/OpenLPT_GUI) - Open-source C++ code for Shake-the-box, particle tracking algorithm. ![C++](logo/cpp.svg) ![MATLAB](logo/Python.svg)
